...
shopifyPaymentButton = this.element.querySelector('.shopify-payment-button');
        ...
        if (this.options['showPaymentButton'] && shopifyPaymentButton) {
          ...
          //BOLD.common.eventEmitter.emit('BOLD_COMMON_clone_addtocart_button', newButton);
}
...
/* BOLD PO Fix
          ...
          */
body: window.FormData ? new FormData(formElement) : JSON.stringify(__WEBPACK_IMPORTED_MODULE_2__helper_Form__["default"].serialize(formElement)),credentials: 'same-origin',
          method: 'POST',
          headers: {/** Bold Removed
